...
#if defined(NDEBUG)
# error "POLI cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "POLI Signed Message:\n";
...
if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
        {
            nSubsidy = 1000000000 * COIN; // 10B coins
        }
