...
git clone https://github.com/POLI/POLI.git
cd POLI
chmod +x linuxPOLI.sh
./linuxPOLI.sh --build
...
git clone https://github.com/POLI/POLI.git
cd POLI
chmod +x linuxPOLI64.sh
./linux64POLI.sh --build

Options:
--reset: update dependencies, clone POLI repository
--force: if you are using other versions such as Debian version > 7

Example with options:
./linux64POLI.sh --reset --force --build

After successful build, POLId can be found in POLI/src/
